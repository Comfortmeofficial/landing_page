...
import { ShieldCheck, LayoutGrid, Share2, Settings, CheckCircle, Clock } from 'lucide-react';
import { Container } from '@/components/common/Container';
import { usePolicyContent } from '@/hooks/usePolicyContent';
import { defaultPrivacyPolicy } from '@/data/defaultPrivacyPolicy';
import type { PolicyBlock } from '@/types';

const sectionMeta = [
  { id: 'commitment',     label: 'Our Commitment',     Icon: ShieldCheck },
  { id: 'data-collection', label: 'Data Collection',    Icon: LayoutGrid  },
  { id: 'data-usage',     label: 'Data Usage',          Icon: LayoutGrid  },
  { id: 'third-party',    label: 'Third-Party Sharing', Icon: Share2      },
  { id: 'your-rights',    label: 'Your Rights',         Icon: Settings    },
];
...
export function PrivacyPolicyPage() {
  ...
  const content = usePolicyContent('privacy', defaultPrivacyPolicy);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-12">
          ...
          <aside className="lg:sticky lg:top-24 self-start">
            ...
            <div className="mt-8 rounded-xl bg-secondary-50 dark:bg-secondary-900/20 p-4">
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
                Have questions about your data? Our Privacy Officer is dedicated to assisting our valued members.
              </p>
              <Link
                to="/contact"
          ...
          <div className="space-y-16">
            ...
            <div className="rounded-2xl border border-gray-200 dark:border-gray-700 p-8 text-center">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Privacy concerns?</h3>
              <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Speak with our dedicated privacy officer for a detailed explanation of our data practices.
              </p>
              <Link
                to="/contact"
